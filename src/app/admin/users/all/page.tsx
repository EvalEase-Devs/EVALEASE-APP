  ...
  return (
    <>
        ...
        <div className="flex flex-1 flex-col items-center justify-center p-8 text-center animate-in fade-in duration-500">
          ...
          <h2 className="text-page-title">All Users</h2>
          <p className="text-muted-foreground mt-2 max-w-md">
            The complete user directory is under development. You&apos;ll soon be able to browse, search, and manage all registered users.
          </p>
        </div>
    </>
  );
