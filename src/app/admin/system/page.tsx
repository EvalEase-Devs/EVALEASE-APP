...
import { IconShieldCheck, IconHammer } from "@tabler/icons-react";
  ...
  return (
    <>
        ...
        <div className="flex flex-1 flex-col items-center justify-center p-8 text-center animate-in fade-in duration-500">
          ...
          <h2 className="text-page-title">System Management</h2>
          <p className="text-muted-foreground mt-2 max-w-md">
            System management tools including health monitoring, audit logs, and backup controls are under development.
          </p>
        </div>
    </>
  );
